...
export default function Header({ nightMode, onToggleNightMode, onReset }: HeaderProps) {
  return (
    <header data-tour="header" className={`${nightMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} shadow-fancy border-b relative overflow-hidden transition-colors duration-300`}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 relative">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3 animate-fade-in-up">
            ...
            {/* Title */}
            <div>
              <h1 className={`text-2xl font-extrabold ${nightMode ? 'text-gray-100' : 'text-primary-600'}`}>
