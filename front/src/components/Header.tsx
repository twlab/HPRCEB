      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={onReset}
              className={`${nightMode ? 'bg-gray-700 hover:bg-red-700 text-gray-300 hover:text-white' : 'bg-gray-100 hover:bg-red-100 text-gray-700 hover:text-red-700'} p-3 rounded-xl transition-all duration-300 hover:scale-110 shadow-lg`}
