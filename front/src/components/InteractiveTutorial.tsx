...
export default function InteractiveTutorial({ 
  ...
  const steps: TutorialStep[] = [
    {
      title: "Welcome! 🎉",
      description: "Quick tour of the HPRC Epigenome Browser. Let's get started!",
    ...
    },
    {
      ...
      description: "Three steps: Sample → Track → Browser. Pick genomes, configure tracks, visualize data.",
      targetSelector: "nav",
      position: "bottom",
      highlightPadding: 10,
    },
    {
      title: "Night Mode 🌙",
      description: "Toggle light/dark theme for comfortable viewing.",
      targetSelector: "header button[aria-label='Toggle night mode']",
      position: "left",
      highlightPadding: 15,
    },
    {
      title: "1. Sample Tab",
      description: "Start here. Choose reference genome, select samples, and pick data layers (methylation, expression, etc.).",
    ...
    {
      title: "2. Track Tab",
      description: "Fine-tune which tracks to display. Enable/disable, search, and reorder tracks.",
    ...
    {
      title: "3. Browser Tab",
      description: "Visualize your data. Zoom, pan, search genes. Press 'F' for fullscreen.",
    ...
    {
      title: "Sessions 💾",
      description: "Save your configuration to reload later.",
    ...
    {
      title: "Data Matrix",
      description: "See which data types are available for each sample.",
    ...
    {
      title: "Need Help? 📚",
      description: "Visit Tutorials for guides and documentation. Restart this tour anytime.",
    ...
    {
      title: "Ready! ✨",
      description: "You're all set! Start in the Sample tab. Happy exploring!",
      targetSelector: "main",
      position: "top",
      highlightPadding: 20,
    },
  ...
  if (!targetRect && !loadingFailed) {
    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-85 z-[9999] flex items-center justify-center">
        <div className={`${nightMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl p-6 max-w-md shadow-2xl`}>
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto"></div>
          <p className={`mt-4 text-center ${nightMode ? 'text-gray-300' : 'text-gray-700'}`}>
            Loading tutorial...
          </p>
        </div>
      </div>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-85 z-[9999] flex items-center justify-center">
        <div className={`${nightMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl p-6 max-w-md shadow-2xl`}>
          <div className="text-center">
            ...
            <h3 className={`text-lg font-bold mb-2 ${nightMode ? 'text-gray-100' : 'text-gray-900'}`}>
              Tutorial Not Available
            </h3>
            <p className={`text-sm mb-4 ${nightMode ? 'text-gray-300' : 'text-gray-700'}`}>
              The tutorial couldn't load properly. You can still use the app normally.
            </p>
            <button
              onClick={handleSkip}
    ...
    <div className={`fixed inset-0 z-[9999] transition-opacity duration-300 ${isAnimating ? 'opacity-0' : 'opacity-100'}`}>
      ...
      <div className="absolute inset-0">
        ...
        <div
          ...
          style={{
            ...spotlightStyle,
            boxShadow: '0 0 0 4px rgba(99, 102, 241, 0.8), 0 0 40px 10px rgba(99, 102, 241, 0.4)',
      ...
      <div
        ref={tooltipRef}
        className={`absolute ${nightMode ? 'bg-gray-800 border-gray-600' : 'bg-white border-gray-200'} rounded-2xl shadow-2xl border-2 p-6 transition-all duration-500 ease-out`}
        style={{
          ...getTooltipStyle(),
          maxWidth: '400px',
          minHeight: '200px',
      ...
      >
        ...
        {/* Content */}
        <div className="mb-6">
          <h3 className={`text-xl font-bold mb-3 ${nightMode ? 'text-gray-100' : 'text-gray-900'}`}>
            {currentStepData.title}
          </h3>
          <p className={`text-sm leading-relaxed ${nightMode ? 'text-gray-300' : 'text-gray-700'}`}>
      ...
      <style>{`
        @keyframes pulse-border {
          0%, 100% {
            box-shadow: 0 0 0 4px rgba(99, 102, 241, 0.8), 0 0 40px 10px rgba(99, 102, 241, 0.4);
          }
          50% {
            box-shadow: 0 0 0 4px rgba(139, 92, 246, 0.8), 0 0 60px 15px rgba(139, 92, 246, 0.6);
          }
        }
      `}</style>
    </div>
